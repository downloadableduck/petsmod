...
public class ClientHappyGhastRenderer extends PetRenderer<@NotNull ClientHappyGhast, @NotNull HappyGhastRenderState, @NotNull HappyGhastModel> {
    ...
    public static final ModelLayerLocation GHAST_LOCATION = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("clienthappyghast"), "main");
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(HappyGhastRenderState livingEntityRenderState) {
        return ResourceLocation.withDefaultNamespace("textures/entity/ghast/happy_ghast.png");
    }
