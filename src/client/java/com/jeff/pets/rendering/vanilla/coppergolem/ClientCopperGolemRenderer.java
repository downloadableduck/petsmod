...
public class ClientCopperGolemRenderer extends PetRenderer<@NotNull ClientCopperGolem, @NotNull CopperGolemRenderState, @NotNull CopperGolemModel> {
    public static ModelLayerLocation COPPER_GOLEM_LOCATION = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("clientcoppergolem"), "main");
    ...
    public ClientCopperGolemRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new RenderLayer<>(() -> model) {
            ...
            public void submit(@NotNull PoseStack poseStack, @NotNull SubmitNodeCollector submitNodeCollector, int i, CopperGolemRenderState entityRenderState, float f, float g) {
                renderColoredCutoutModel(this.getParentModel(), ResourceLocation.withDefaultNamespace("textures/entity/copper_golem/copper_golem_eyes.png"), poseStack, submitNodeCollector, entityRenderState.lightCoords, entityRenderState, -1, OverlayTexture.NO_OVERLAY);
            }
        });
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(CopperGolemRenderState copperGolemRenderState) {
        ...
        return ResourceLocation.withDefaultNamespace(copperGolemTexturePath);
    }
