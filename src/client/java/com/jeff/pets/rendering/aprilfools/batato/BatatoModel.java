...
public class BatatoModel extends HierarchicalModel<Batato> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(19, 20).addBox(-1.5F, -2.0F, 0.0F, 13.0F, 12.0F, 0.01F).texOffs(6, 20).mirror().addBox(-1.5F, -2.0F, 0.0F, 13.0F, 12.0F, 0.01F), PartPose.offset(0.0F, 17.0F, 0.0F));
