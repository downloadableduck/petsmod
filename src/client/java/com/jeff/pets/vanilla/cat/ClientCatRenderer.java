...
public class ClientCatRenderer extends MobRenderer<@NotNull ClientCat, @NotNull CatRenderState, @NotNull AdultCatModel> {
    ...
    public ClientCatRenderer(EntityRendererProvider.Context context) {
        super(context, new AdultCatModel(context.bakeLayer(ModelLayers.CAT)), 0.7F);
    }
