...
public class PetsConfigScreen extends Screen {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mousex, int mousey, float a) {
        ...
        graphics.text(this.font, Component.literal(Utils.capitalize("Your currently selected pet is: ")), (this.width - font.width("Your currently selected pet is: ")) / 2, this.height - this.font.lineHeight - 35, color);
        graphics.pose().pushMatrix();
        graphics.pose().translate(x, y);
        graphics.pose().scale(2);
        graphics.text(this.font, Component.literal(Utils.capitalize(CONFIG.activePet).replaceAll("_", " ")), 0, 0, color);
