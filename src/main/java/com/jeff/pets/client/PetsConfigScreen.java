...
import com.jeff.pets.client.enums.DuckSkins;
...
public class PetsConfigScreen {
     ...
     */
    public void getModConfigScreenFactory() {
        /*return parentScreen -> {
                            ...
                            .group(OptionGroup.createBuilder()
                                    ...
                                    .option(Option.<Enum>createBuilder()
                                            ...
                                            .binding(
                                                    ...
                                                    newVal -> {
                                                        Central.despawnPet();
                                                        CONFIG.activePet = String.valueOf(newVal).replaceAll(" ", "_");
                                                        Central.summonPet();
                                                    }
                                            )
                                    ...
                                    .option(Option.<Enum<?>>createBuilder()
                                            ...
                                            .available(!Objects.equals(CONFIG.activePet, "head"))
                                            .build())
                                    .option(Option.<Boolean>createBuilder()
                                            .name(Component.literal("Baby?"))
                                            .description(OptionDescription.of(Component.literal("Universal toggle for whether your pet is a baby. Please note that some mobs may not support this feature.")))
                                            .binding(
                                                    false,
                                                    () -> CONFIG.isBaby,
