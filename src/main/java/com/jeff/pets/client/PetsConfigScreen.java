...
public class PetsConfigScreen extends Screen {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mousex, int mousey, float a) {
        ...
        graphics.text(this.font, Component.nullToEmpty(StringUtil.capitalize("Your currently selected pet is: ")), (this.width - font.width("Your currently selected pet is: ")) / 2, this.height - this.font.lineHeight - 35, color);
