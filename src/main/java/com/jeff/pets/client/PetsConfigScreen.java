...
public class PetsConfigScreen extends Screen {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mousex, int mousey, float a) {
        ...
        graphics.text(this.font, Component.nullToEmpty(Utils.capitalize("Your currently selected pet is: ")), (this.width - font.width("Your currently selected pet is: ")) / 2, this.height - this.font.lineHeight - 35, color);
        graphics.pose().pushMatrix();
        graphics.pose().translate(x, y);
        graphics.pose().scale(2);
        graphics.text(this.font, Component.nullToEmpty(Utils.capitalize(CONFIG.activePet).replaceAll("_", " ")), 0, 0, color);
    ...
    public void init() {
        ...
        this.addRenderableWidget(new ToggleButton(this.width - 42, this.height / 2 - 80, Component.nullToEmpty("Show hitboxes?"), (_) -> {
            CONFIG.renderPetHitbox = !CONFIG.renderPetHitbox;
        }, () -> CONFIG.renderPetHitbox, this, 34));
        this.addRenderableWidget(new ToggleButton(this.width - 42, this.height / 2 - 40, Component.nullToEmpty("Pet On?"), (_) -> {
        ...
        this.addRenderableWidget(new ToggleButton(this.width - 42, this.height / 2 + 40, Component.nullToEmpty("Always show nametag?"), (_) -> {
            CONFIG.alwaysRenderNametag = !CONFIG.alwaysRenderNametag;
        }, () -> CONFIG.alwaysRenderNametag, this, 69));
        this.addRenderableWidget(new ToggleButton(this.width - 42, this.height / 2 + 80, Component.nullToEmpty("Baby?"), (_) -> {
