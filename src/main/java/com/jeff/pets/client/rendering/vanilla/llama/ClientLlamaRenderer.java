...
public class ClientLlamaRenderer extends PetRenderer<ClientLlama, ClientLlamaModel> {
    ...
    public ClientLlamaRenderer(net.minecraft.client.renderer.entity.EntityRendererManager context) {
        super(context, new ClientLlamaModel(0), 0.75F);
    }

    @Override
    protected void scale(ClientLlama state, MatrixStack poseStack, float f) {
        if (CONFIG.isBaby) {
