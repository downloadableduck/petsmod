...
public class ClientZombiePigmanModel extends ModelBase {
    ...
    public ClientZombiePigmanModel() {
        ...
        head.setTextureOffset(0, 0).func_205345_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F, false);

        headwear = new ModelRenderer(this);
        headwear.setRotationPoint(0.0F, 0.0F, 0.0F);
        headwear.setTextureOffset(32, 0).func_205345_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.5F, false);

        body = new ModelRenderer(this);
        body.setRotationPoint(0.0F, 0.0F, 0.0F);
        body.setTextureOffset(16, 16).func_205345_a(-4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F, false);

        left_arm = new ModelRenderer(this);
        left_arm.setRotationPoint(5.0F, 2.0F, 0.0F);
        left_arm.setTextureOffset(40, 16).func_205345_a(-1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false);

        right_arm = new ModelRenderer(this);
        right_arm.setRotationPoint(-5.0F, 2.0F, 0.0F);
        right_arm.setTextureOffset(40, 16).func_205345_a(-3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false);

        left_leg = new ModelRenderer(this);
        left_leg.setRotationPoint(1.9F, 12.0F, 0.0F);
        left_leg.setTextureOffset(0, 16).func_205345_a(-1.9F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false);

        right_leg = new ModelRenderer(this);
        right_leg.setRotationPoint(-1.9F, 12.0F, 0.0F);
        right_leg.setTextureOffset(0, 16).func_205345_a(-2.1F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false);
    }
