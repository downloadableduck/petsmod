...
public class ClientCreeperChargeLayer extends FeatureRenderer<ClientCreeper, CreeperEntityModel<ClientCreeper>> {
    private static final Identifier SKIN = new Identifier("textures/entity/creeper/creeper_armor.png");
    public ClientCreeperChargeLayer(FeatureRendererContext<ClientCreeper, CreeperEntityModel<ClientCreeper>> featureRendererContext) {
    ...
    public void render(ClientCreeper creeperEntity, float f, float g, float h, float i, float j, float k, float l) {
        if (CONFIG.creeperSkin.equals("charged")) {
            ...
            (this.getModel()).copyStateTo(this.getModel());
