...
public class ClientSquidRenderer extends PetRenderer<ClientSquid, SquidModel<ClientSquid>> {
    ...
    @Override
    protected void scale(ClientSquid livingEntityRenderState, float f) {
        if (CONFIG.isBaby) {
    ...
    @Override
    protected void setupRotations(ClientSquid squid, float f, float g, float h) {
        ...
        com.mojang.blaze3d.platform.GlStateManager.translatef(0.0F, 0.5F, 0.0F);
        //poseStack.mulPose(Vector3f.YP.rotationDegrees(180.0F - g));
        //poseStack.mulPose(Vector3f.XP.rotationDegrees(j));
        //poseStack.mulPose(Vector3f.YP.rotationDegrees(k));
        com.mojang.blaze3d.platform.GlStateManager.translatef(0.0F, -1.2F, 0.0F);
    }
