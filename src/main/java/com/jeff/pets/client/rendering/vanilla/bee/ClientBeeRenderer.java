...
public class ClientBeeRenderer extends PetRenderer<@NotNull ClientBee, @NotNull ClientBeeModel> {
    ...
    public ClientBeeRenderer(net.minecraft.client.renderer.entity.EntityRenderDispatcher context, net.fabricmc.fabric.api.client.rendereregistry.v1.EntityRendererRegistry.Context context2) {
