...
public class ClientDrownedRenderer extends PetRenderer< ClientDrowned,  ClientDrownedModel> {
    ...
    @Override
    protected void scale(ClientDrowned state,  PoseStack poseStack, float f) {
        if (CONFIG.isBaby) {
    ...
    @Override
    public void setupRotations(ClientDrowned state,  PoseStack poseStack, float f, float g, float i) {
