...
public class StingrayModel extends PetModel {
    ...
    public StingrayModel() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_205345_a(-6.0F, -2.0F, -6.0F, (int) 12.0F, (int) 2.0F, (int) 12.0F, 0.0F, false);

        tail = new ModelRenderer(this);
        tail.setRotationPoint(0.0F, -2.0F, 0.0F);
        root.addChild(tail);
        tail.setTextureOffset(0, 14).func_205345_a(-1.0F, -2.0F, 6.0F, (int) 2.0F, (int) 2.0F, (int) 10.0F, 0.0F, false);

        right_fin = new ModelRenderer(this);
        right_fin.setRotationPoint(6.0F, -4.0F, -1.0F);
        root.addChild(right_fin);
        right_fin.setTextureOffset(24, 14).func_205345_a(0.0F, 0.0F, -3.0F, (int) 4.0F, (int) 2.0F, (int) 6.0F, 0.0F, false);

        left_fin = new ModelRenderer(this);
        left_fin.setRotationPoint(-6.0F, -4.0F, -1.0F);
        root.addChild(left_fin);
        left_fin.setTextureOffset(24, 22).func_205345_a(-4.0F, 0.0F, -3.0F, (int) 4.0F, (int) 2.0F, (int) 6.0F, 0.0F, false);
    }
