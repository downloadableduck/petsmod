...
public class ClientRabbitModel extends EntityModel<ClientRabbit> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partDefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(32, 9).addBox(-0.5F, -2.5F, -5.5F, 1.0F, 1.0f, 1.0f, true), PartPose.offset(0.0F, 16.0F, -1.0F));
    ...
    public void setupAnim(ClientRabbit rabbit, float f, float g, float h, float i, float j) {
        ...
        this.rightEar.xRot = j * ((float) Math.PI / 180F);
        this.leftEar.xRot = j * ((float) Math.PI / 180F);
        ...
        this.jumpRotation = Mth.sin(1 * (float) Math.PI);
