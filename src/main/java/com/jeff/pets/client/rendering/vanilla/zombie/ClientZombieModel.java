...
public class ClientZombieModel<T extends AbstractPet> extends EntityModel<@NotNull T> {
    ...
    public ClientZombieModel() {
        ...
        left_arm.setTextureOffset(40, 16).addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, true);
        ...
        left_leg.setTextureOffset(0, 16).addBox(-1.9F, 0.0F, -2.0F, 4, 12, 4, 0.0F, true);
    ...
    @Override
    public void setAngles(T state, float f, float g, float h, float i, float j, float s) {
        boolean bl = false;
        ...
        AnimationUtils.animateZombieArms(this.left_arm, this.right_arm, true, this.handSwingProgress, h);
    }
