...
public class ClientZombieModel<T extends AbstractPet> extends EntityModel<T> {
    ...
    public ClientZombieModel() {
        ...
        left_arm.texOffs(40, 16).addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, true);
        ...
        left_leg.texOffs(0, 16).addBox(-1.9F, 0.0F, -2.0F, 4, 12, 4, 0.0F, true);
    ...
    public void setupAnim(T state, float f, float g, float h, float i, float j, float s) {
        ...
        ModelUtils.animateZombieArms(this.left_arm, this.right_arm, true, this.attackTime, h);
    }
