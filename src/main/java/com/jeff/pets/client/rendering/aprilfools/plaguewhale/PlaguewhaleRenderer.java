...
public class PlaguewhaleRenderer extends PetRenderer< PlaguewhaleSlab,  ToxifinSlabModel<PlaguewhaleSlab>> {
    ...
    @Override
    public  ResourceLocation getTextureLocation(PlaguewhaleSlab livingEntityRenderState) {
