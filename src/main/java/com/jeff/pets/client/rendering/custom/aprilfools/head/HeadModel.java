...
public class HeadModel extends ModelBase {
    ...
    public HeadModel() {
        ...
        Head.setTextureOffset(0, 0).func_205345_a(-8.0F, 16.0F, 0.0F, (int) 8.0F, (int) 8.0F, (int) 8.0F, 0.0F, false);
        Head.setTextureOffset(32, 0).func_205345_a(-4.0F, -8.0F, -4.0F, (int) 8.0F, (int) 8.0F, (int) 8.0F, 0.5F, false);
    }
