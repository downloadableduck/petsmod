...
public class NerdCreeperRenderer extends PetRenderer< NerdCreeper,  CreeperModel<NerdCreeper>> {
    ...
    @Override
    public  ResourceLocation getTextureLocation(NerdCreeper livingEntityRenderState) {
