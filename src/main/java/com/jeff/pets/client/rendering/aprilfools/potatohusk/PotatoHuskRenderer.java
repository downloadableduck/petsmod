...
public class PotatoHuskRenderer extends PetRenderer< PotatoHusk,  ClientZombieModel<PotatoHusk>> {
    ...
    protected void scale(PotatoHusk state,  PoseStack poseStack, float f) {
    ...
    @Override
    public  ResourceLocation getTextureLocation(PotatoHusk livingEntityRenderState) {
