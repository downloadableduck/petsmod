...
public class ClientSnifferRenderer extends PetRenderer<@NotNull ClientSniffer, @NotNull ClientSnifferModel> {
    ...
    @Override
    protected void scale(@NotNull ClientSniffer livingEntityRenderState, @NotNull PoseStack poseStack, float f) {
        if (CONFIG.isBaby) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(ClientSniffer snifferRenderState) {
