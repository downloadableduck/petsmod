...
public class KoiModel extends PetModel {
    ...
    public KoiModel() {
        ...
        body.setTextureOffset(0, 0).func_205345_a(-2.0F, -4.0F, -2.0F, (int) 4.0F, (int) 4.0F, (int) 14.0F, 0.0F, false);

        top_fin = new ModelRenderer(this);
        top_fin.setRotationPoint(-4.0F, 0.0F, 8.0F);
        body.addChild(top_fin);
        top_fin.setTextureOffset(16, 26).func_205345_a(4.0F, -6.0F, -6.0F, (int) 0.0F, (int) 2.0F, (int) 4.0F, 0.0F, false);
        ...
        left_hind_fin_r1.setTextureOffset(24, 26).func_205345_a(0.6F, 0.0F, 0.0F, (int) 2.0F, (int) 0.0F, (int) 2.0F, 0.0F, false);
        ...
        right_hind_fin_r1.setTextureOffset(24, 28).func_205345_a(0.0F, 0.0F, 0.0F, (int) 2.0F, (int) 0.0F, (int) 2.0F, 0.0F, false);
        ...
        left_fin_r1.setTextureOffset(16, 22).func_205345_a(-1.4F, 0.0F, -2.0F, (int) 4.0F, (int) 0.0F, (int) 4.0F, 0.0F, false);
        ...
        right_fin_r1.setTextureOffset(16, 18).func_205345_a(-2.6F, 0.0F, -2.0F, (int) 4.0F, (int) 0.0F, (int) 4.0F, 0.0F, false);

        tail_fin = new ModelRenderer(this);
        tail_fin.setRotationPoint(0.0F, 0.0F, 14.0F);
        body.addChild(tail_fin);
        tail_fin.setTextureOffset(0, 18).func_205345_a(0.0F, -8.0F, -2.0F, (int) 0.0F, (int) 12.0F, (int) 8.0F, 0.0F, false);
    }
