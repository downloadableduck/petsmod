...
public class KoiModel extends PetModel {
    ...
    public KoiModel() {
        ...
        body.setTextureCoords(0, 0).addBox(-2.0F, -4.0F, -2.0F, 4, 4, 14, 0.0F);

        top_fin = new ModelPart(this);
        top_fin.setPos(-4.0F, 0.0F, 8.0F);
        body.addChild(top_fin);
        top_fin.setTextureCoords(16, 26).addBox(4.0F, -6.0F, -6.0F, 0, 2, 4, 0.0F);
        ...
        left_hind_fin_r1.setTextureCoords(24, 26).addBox(0.6F, 0.0F, 0.0F, 2, 0, 2, 0.0F);
        ...
        right_hind_fin_r1.setTextureCoords(24, 28).addBox(0.0F, 0.0F, 0.0F, 2, 0, 2, 0.0F);
        ...
        left_fin_r1.setTextureCoords(16, 22).addBox(-1.4F, 0.0F, -2.0F, 4, 0, 4, 0.0F);
        ...
        right_fin_r1.setTextureCoords(16, 18).addBox(-2.6F, 0.0F, -2.0F, 4, 0, 4, 0.0F);

        tail_fin = new ModelPart(this);
        tail_fin.setPos(0.0F, 0.0F, 14.0F);
        body.addChild(tail_fin);
        tail_fin.setTextureCoords(0, 18).addBox(0.0F, -8.0F, -2.0F, 0, 12, 8, 0.0F);
    }
