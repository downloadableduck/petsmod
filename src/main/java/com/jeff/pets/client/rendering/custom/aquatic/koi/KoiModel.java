...
public class KoiModel extends PetModel {
    ...
    public KoiModel() {
        ...
        body.setTextureOffset(0, 0).addBox(-2.0F, -4.0F, -2.0F, (int) 4.0F, (int) 4.0F, (int) 14.0F, 0.0F);

        top_fin = new ModelRenderer(this);
        top_fin.setRotationPoint(-4.0F, 0.0F, 8.0F);
        body.addChild(top_fin);
        top_fin.setTextureOffset(16, 26).addBox(4.0F, -6.0F, -6.0F, (int) 0.0F, (int) 2.0F, (int) 4.0F, 0.0F);
        ...
        left_hind_fin_r1.setTextureOffset(24, 26).addBox(0.6F, 0.0F, 0.0F, (int) 2.0F, (int) 0.0F, (int) 2.0F, 0.0F);
        ...
        right_hind_fin_r1.setTextureOffset(24, 28).addBox(0.0F, 0.0F, 0.0F, (int) 2.0F, (int) 0.0F, (int) 2.0F, 0.0F);
        ...
        left_fin_r1.setTextureOffset(16, 22).addBox(-1.4F, 0.0F, -2.0F, (int) 4.0F, (int) 0.0F, (int) 4.0F, 0.0F);
        ...
        right_fin_r1.setTextureOffset(16, 18).addBox(-2.6F, 0.0F, -2.0F, (int) 4.0F, (int) 0.0F, (int) 4.0F, 0.0F);

        tail_fin = new ModelRenderer(this);
        tail_fin.setRotationPoint(0.0F, 0.0F, 14.0F);
        body.addChild(tail_fin);
        tail_fin.setTextureOffset(0, 18).addBox(0.0F, -8.0F, -2.0F, (int) 0.0F, (int) 12.0F, (int) 8.0F, 0.0F);
    }
