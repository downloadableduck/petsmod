...
public class ClientBatModel extends SegmentedModel<ClientBat> {
    ...
    public ClientBatModel() {
        ...
        ModelRenderer modelPart = new ModelRenderer(this, 24, 0);
        modelPart.addBox(-4.0F, -6.0F, -2.0F, 3.0F, 4.0F, 1.0F);
        this.head.addChild(modelPart);
        ModelRenderer modelPart2 = new ModelRenderer(this, 24, 0);
