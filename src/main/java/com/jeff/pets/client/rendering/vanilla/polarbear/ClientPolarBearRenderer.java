...
public class ClientPolarBearRenderer extends PetRenderer<@NotNull ClientPolarBear> {
    ...
    public ClientPolarBearRenderer(net.minecraft.client.render.entity.EntityRenderDispatcher context, com.jeff.pets.client.PetsClientInitializer.Context context2) {
        super(context, new ClientPolarBearModel(), 0.7F);
    }

    @Override
    protected void scale(ClientPolarBear state, float f) {
        super.scale(state, f);
        if (CONFIG.isBaby) {
