...
public class PenguinModel extends PetModel {
    ...
    public PenguinModel() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_205345_a(-8.0F, -20.0F, 0.0F, (int) 8.0F, (int) 12.0F, (int) 8.0F, 0.0F, false);

        left_wing = new ModelRenderer(this);
        left_wing.setRotationPoint(-4.0F, -15.0F, 8.5F);
        root.addChild(left_wing);
        setRotationAngle(left_wing, 0.0F, 0.0F, -1.5708F);
        left_wing.setTextureOffset(24, 25).func_205345_a(-10.0F, -3.0F, -0.5F, (int) 10.0F, (int) 6.0F, (int) 1.0F, 0.0F, false);

        right_wing = new ModelRenderer(this);
        right_wing.setRotationPoint(-4.0F, -15.0F, 0.0F);
        root.addChild(right_wing);
        setRotationAngle(right_wing, 0.0F, 0.0F, -1.5708F);
        right_wing.setTextureOffset(24, 25).func_205345_a(-10.0F, -3.0F, -1.0F, (int) 10.0F, (int) 6.0F, (int) 1.0F, 0.0F, false);
        ...
        left_foot_r1.setTextureOffset(0, 32).func_205345_a(-1.0F, -6.0F, 2.0F, (int) 2.0F, (int) 6.0F, (int) 4.0F, 0.0F, false);
        ...
        right_foot_r1.setTextureOffset(32, 0).func_205345_a(-1.0F, -6.0F, 2.0F, (int) 2.0F, (int) 6.0F, (int) 4.0F, 0.0F, false);

        tail = new ModelRenderer(this);
        tail.setRotationPoint(-3.0F, -3.0F, 2.0F);
        root.addChild(tail);
        tail.setTextureOffset(-8, -8).func_205345_a(3.0F, -4.0F, 0.0F, (int) 2.0F, (int) 2.0F, (int) 4.0F, 0.0F, false);

        head = new ModelRenderer(this);
        head.setRotationPoint(1.0F, -5.0F, 3.0F);
        root.addChild(head);
        head.setTextureOffset(0, 20).func_205345_a(-8.0F, -17.0F, -2.0F, (int) 6.0F, (int) 6.0F, (int) 6.0F, 0.0F, false);

        beak = new ModelRenderer(this);
        beak.setRotationPoint(0.0F, 0.0F, 0.0F);
        head.addChild(beak);
        beak.setTextureOffset(12, 32).func_205345_a(-2.0F, -14.0F, 0.0F, (int) 4.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);
    }
