...
public class ClientHorseModel<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ClientHorseModel(float f) {
        ...
        this.field_3307.pitch = ((float) Math.PI / 6F);
        ...
        this.field_3300.pitch = ((float) Math.PI / 6F);
    ...
    public void animateModel(T horseBaseEntity, float f, float g, float h) {
        ...
        this.field_3307.pitch = ((float) Math.PI / 6F) + m;
        this.field_3307.yaw = l * ((float) Math.PI / 180F);
        ...
        this.field_3307.yaw = o * l * ((float) Math.PI / 180F) + (1.0F - Math.max(o, n)) * this.field_3307.yaw;
        ...
        this.field_3305.pitch = o * (-(float) Math.PI / 4F) + p * this.field_3305.pitch;
        ...
        this.field_3300.pitch = ((float) Math.PI / 6F) + g * 0.75F;
