...
public class ClientHorseModel<T extends LivingEntity> extends AgeableListModel<T> {
    ...
    public ClientHorseModel(ModelPart modelPart) {
    ...
    public static MeshDefinition createBodyMesh(CubeDeformation cubeDeformation) {
        ...
        PartDefinition partDefinition3 = partDefinition.addOrReplaceChild("head_parts", CubeListBuilder.create().texOffs(0, 35).addBox(-2.05F, -6.0F, -2.0F, 4.0F, 12.0F, 7.0F), PartPose.offsetAndRotation(0.0F, 4.0F, -12.0F, ((float) Math.PI / 6F), 0.0F, 0.0F));
        ...
        partDefinition2.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(42, 36).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 14.0F, 4.0F, cubeDeformation), PartPose.offsetAndRotation(0.0F, -5.0F, 2.0F, ((float) Math.PI / 6F), 0.0F, 0.0F));
        ...
        partDefinition3.addOrReplaceChild("left_saddle_line", CubeListBuilder.create().texOffs(32, 2).addBox(3.1F, -6.0F, -8.0F, 0.0F, 3.0F, 16.0F), PartPose.rotation((-(float) Math.PI / 6F), 0.0F, 0.0F));
        partDefinition3.addOrReplaceChild("right_saddle_line", CubeListBuilder.create().texOffs(32, 2).addBox(-3.1F, -6.0F, -8.0F, 0.0F, 3.0F, 16.0F), PartPose.rotation((-(float) Math.PI / 6F), 0.0F, 0.0F));
