...
public class ClientDonkeyRenderer extends PetRenderer<@NotNull ClientDonkey, @NotNull ClientHorseModel<ClientDonkey>> {
    ...
    public ClientDonkeyRenderer(net.minecraft.client.render.entity.EntityRenderDispatcher context, net.fabricmc.fabric.api.client.render.EntityRendererRegistry.Context context2) {
        super(context, new ClientHorseModel<>(0), 0.5f);
    }

    public @NotNull Identifier getTexture(ClientDonkey donkeyRenderState) {
