...
public class ClientSnifferModel extends AgeableHierarchicalModel<ClientSniffer> {
    ...
    public ClientSnifferModel(ModelPart modelPart) {
        super(0.5F, 24.0F);
    ...
    public void setupAnim(ClientSniffer sniffer, float f, float g, float h, float i, float j) {
