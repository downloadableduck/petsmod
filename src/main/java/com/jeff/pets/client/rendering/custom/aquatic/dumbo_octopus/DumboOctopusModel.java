...
public class DumboOctopusModel extends PetModel {
    ...
    public DumboOctopusModel() {
        ...
        body.setTextureCoords(0, 0).addBox(-4.0F, -5.0F, -3.0F, 6, 6, 6, 0.0F, false);
        ...
        left_ear_r1.setTextureCoords(8, 12).addBox(-1.0F, -2.0F, -0.5F, 2, 2, 1, 0.0F, false);
        ...
        right_ear_r1.setTextureCoords(8, 12).addBox(-1.0F, -2.0F, -0.5F, 2, 2, 1, 0.0F, false);

        leg1 = new ModelPart(this);
        leg1.setPos(-4.0F, 1.0F, 2.0F);
        body.addChild(leg1);
        leg1.setTextureCoords(0, 12).addBox(-2.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false);

        leg2 = new ModelPart(this);
        leg2.setPos(-4.0F, 1.0F, -1.0F);
        body.addChild(leg2);
        leg2.setTextureCoords(0, 12).addBox(-2.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false);

        leg3 = new ModelPart(this);
        leg3.setPos(-3.0F, 1.0F, -3.0F);
        body.addChild(leg3);
        leg3.setTextureCoords(0, 12).addBox(-1.0F, -1.0F, -2.0F, 2, 2, 2, 0.0F, false);

        leg4 = new ModelPart(this);
        leg4.setPos(0.0F, 1.0F, -3.0F);
        body.addChild(leg4);
        leg4.setTextureCoords(0, 12).addBox(-1.0F, -1.0F, -2.0F, 2, 2, 2, 0.0F, false);

        leg5 = new ModelPart(this);
        leg5.setPos(2.0F, 1.0F, -2.0F);
        body.addChild(leg5);
        leg5.setTextureCoords(0, 12).addBox(0.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false);

        leg6 = new ModelPart(this);
        leg6.setPos(2.0F, 1.0F, 1.0F);
        body.addChild(leg6);
        leg6.setTextureCoords(0, 12).addBox(0.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false);

        leg7 = new ModelPart(this);
        leg7.setPos(1.0F, 1.0F, 3.0F);
        body.addChild(leg7);
        leg7.setTextureCoords(0, 12).addBox(-1.0F, -1.0F, 0.0F, 2, 2, 2, 0.0F, false);

        leg8 = new ModelPart(this);
        leg8.setPos(-2.0F, 1.0F, 3.0F);
        body.addChild(leg8);
        leg8.setTextureCoords(0, 12).addBox(-1.0F, -1.0F, 0.0F, 2, 2, 2, 0.0F, false);
    }
