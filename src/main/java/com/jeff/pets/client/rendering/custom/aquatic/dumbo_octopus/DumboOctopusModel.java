...
public class DumboOctopusModel extends PetModel {
    ...
    public DumboOctopusModel() {
        ...
        body.setTextureOffset(0, 0).func_205345_a(-4.0F, -5.0F, -3.0F, (int) 6.0F, (int) 6.0F, (int) 6.0F, 0.0F, false);
        ...
        left_ear_r1.setTextureOffset(8, 12).func_205345_a(-1.0F, -2.0F, -0.5F, (int) 2.0F, (int) 2.0F, (int) 1.0F, 0.0F, false);
        ...
        right_ear_r1.setTextureOffset(8, 12).func_205345_a(-1.0F, -2.0F, -0.5F, (int) 2.0F, (int) 2.0F, (int) 1.0F, 0.0F, false);

        leg1 = new ModelRenderer(this);
        leg1.setRotationPoint(-4.0F, 1.0F, 2.0F);
        body.addChild(leg1);
        leg1.setTextureOffset(0, 12).func_205345_a(-2.0F, -1.0F, -1.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg2 = new ModelRenderer(this);
        leg2.setRotationPoint(-4.0F, 1.0F, -1.0F);
        body.addChild(leg2);
        leg2.setTextureOffset(0, 12).func_205345_a(-2.0F, -1.0F, -1.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg3 = new ModelRenderer(this);
        leg3.setRotationPoint(-3.0F, 1.0F, -3.0F);
        body.addChild(leg3);
        leg3.setTextureOffset(0, 12).func_205345_a(-1.0F, -1.0F, -2.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg4 = new ModelRenderer(this);
        leg4.setRotationPoint(0.0F, 1.0F, -3.0F);
        body.addChild(leg4);
        leg4.setTextureOffset(0, 12).func_205345_a(-1.0F, -1.0F, -2.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg5 = new ModelRenderer(this);
        leg5.setRotationPoint(2.0F, 1.0F, -2.0F);
        body.addChild(leg5);
        leg5.setTextureOffset(0, 12).func_205345_a(0.0F, -1.0F, -1.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg6 = new ModelRenderer(this);
        leg6.setRotationPoint(2.0F, 1.0F, 1.0F);
        body.addChild(leg6);
        leg6.setTextureOffset(0, 12).func_205345_a(0.0F, -1.0F, -1.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg7 = new ModelRenderer(this);
        leg7.setRotationPoint(1.0F, 1.0F, 3.0F);
        body.addChild(leg7);
        leg7.setTextureOffset(0, 12).func_205345_a(-1.0F, -1.0F, 0.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);

        leg8 = new ModelRenderer(this);
        leg8.setRotationPoint(-2.0F, 1.0F, 3.0F);
        body.addChild(leg8);
        leg8.setTextureOffset(0, 12).func_205345_a(-1.0F, -1.0F, 0.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F, false);
    }
