...
public class ClientRabbitRenderer extends PetRenderer<@NotNull ClientRabbit> {
    ...
    @Override
    protected void scale(ClientRabbit state, float f) {
        if (CONFIG.isBaby) {
    ...
    @Override
    public @NotNull Identifier getTexture(ClientRabbit livingEntityRenderState) {
