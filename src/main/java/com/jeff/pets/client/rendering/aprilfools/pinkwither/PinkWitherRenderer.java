package com.jeff.pets.client.rendering.aprilfools.pinkwither;

import com.jeff.pets.client.mixin.client.WitherRenderStateAccessor;
...
public class PinkWitherRenderer extends PetRenderer<@NotNull PinkWither, @NotNull WitherRenderState, @NotNull WitherBossModel> {
    ...
    public void extractRenderState(PinkWither wither, WitherRenderState state, float f) {
        ...
        WitherRenderStateAccessor.setYHeadRots(state, new float[]{wither.getYHeadRot(), wither.getYHeadRot(), wither.getYHeadRot()});
    }
}
