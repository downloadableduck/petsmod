...
public class ClientFoxModel extends EntityModel<ClientFox> {
    ...
    @Override
    public void animateModel(ClientFox foxEntity, float f, float g, float h) {
    ...
    @Override
    public void setAngles(ClientFox foxEntity, float f, float g, float h, float i, float j, float k) {
