...
public class ClientSalmonRenderer extends PetRenderer< ClientSalmon,  ClientSalmonModel> {
    ...
    @Override
    protected void setupRotations(ClientSalmon salmonRenderState,  PoseStack poseStack, float ageInTicks, float g, float a) {
