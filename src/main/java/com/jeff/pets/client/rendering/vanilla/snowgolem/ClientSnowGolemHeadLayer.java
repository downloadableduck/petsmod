...
public class ClientSnowGolemHeadLayer implements LayerRenderer<ClientSnowGolem> {
    ...
    public void doRenderLayer(ClientSnowGolem snowGolem, float f, float g, float h, float i, float j, float k, float l) {
        if (CONFIG.snowGolemSkin.equals("pumpkin_on")) {
            ...
            if (!snowGolem.isInvisible() || bl) {
                ...
                net.minecraft.client.renderer.GlStateManager.scale(0.625F, -0.625F, -0.625F);
