...
public class DuckModel extends PetModel {
    ...
    public DuckModel() {
        ...
        root.addChild(head);
        head.setTextureOffset(0, 0).addBox(-1.5F, -5.0F, -1.5F, (int) 3.0F, (int) 6.0F, (int) 3.0F, 0.0F);
        ...
        bill_r1.setTextureOffset(14, 0).addBox(-2.2F, -13.0F, -8.0F, (int) 2.0F, (int) 1.0F, (int) 2.0F, 0.0F);

        body = new ModelRenderer(this);
        body.setRotationPoint(0.0F, 1.0F, 4.0F);
        root.addChild(body);
        setRotationAngle(body, 1.5708F, 0.0F, 0.0F);
        body.setTextureOffset(1, 10).addBox(-2.5F, -4.0F, -4.0F, (int) 5.0F, (int) 8.0F, (int) 5.0F, 0.0F);

        left_wing = new ModelRenderer(this);
        left_wing.setRotationPoint(3.0F, 0.0F, 4.0F);
        root.addChild(left_wing);
        left_wing.setTextureOffset(24, 13).addBox(-0.5F, 0.0F, -3.0F, (int) 1.0F, (int) 3.0F, (int) 6.0F, 0.0F);

        right_wing = new ModelRenderer(this);
        right_wing.setRotationPoint(-3.0F, 0.0F, 4.0F);
        root.addChild(right_wing);
        right_wing.setTextureOffset(24, 13).addBox(-0.5F, 0.0F, -3.0F, (int) 1.0F, (int) 3.0F, (int) 6.0F, 0.0F);

        left_leg = new ModelRenderer(this);
        left_leg.setRotationPoint(1.0F, 4.0F, 5.0F);
        root.addChild(left_leg);
        left_leg.setTextureOffset(26, 0).addBox(-1.0F, 0.0F, -3.0F, (int) 3.0F, (int) 5.0F, (int) 3.0F, 0.0F);

        right_leg = new ModelRenderer(this);
        right_leg.setRotationPoint(-2.0F, 4.0F, 5.0F);
        root.addChild(right_leg);
        right_leg.setTextureOffset(26, 0).addBox(-1.0F, 0.0F, -3.0F, (int) 3.0F, (int) 5.0F, (int) 3.0F, 0.0F);

        tail = new ModelRenderer(this);
        tail.setRotationPoint(0.0F, 4.0F, 9.0F);
        root.addChild(tail);
        tail.setTextureOffset(0, 23).addBox(-1.0F, -2.0F, -1.0F, (int) 2.0F, (int) 2.0F, (int) 2.0F, 0.0F);
    }
