...
public class PetsClientInitializer {
    ...
    void register(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(PetsInitializer.Entities.CREAKING.get(), ClientCreakingRenderer::new);
        ...
        event.registerEntityRenderer(PetsInitializer.Entities.SULFUR_CUBE.get(), ClientSulfurCubeRenderer::new);
    }
