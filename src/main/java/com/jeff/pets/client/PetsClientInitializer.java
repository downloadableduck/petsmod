 ...
 * <p> - Assigns renderers to the entities defined in {@link LiteModPetsMod}
...
public class PetsClientInitializer {
    ...
    public static KeyBinding openConfigScreen = new KeyBinding("Open Pets Menu", Keyboard.KEY_P, "petsmod.keymapping");;
    ...
    public static void printAddons() {
        LiteModPetsMod.LOGGER.info("PetsMod addons loaded:{}", ADDONS);
    }
