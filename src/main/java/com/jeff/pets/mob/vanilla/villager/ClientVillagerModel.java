package com.jeff.pets.mob.vanilla.villager;
...
/**
 * DO NOT DELETE, the villager requires a custom model to work properly
 */
public class ClientVillagerModel extends EntityModel<@NotNull LivingEntityRenderState> {
    private final ModelPart head;
    private final ModelPart rightLeg;
    private final ModelPart leftLeg;
    private final ModelPart arms;

    public ClientVillagerModel(ModelPart modelPart) {
        super(modelPart);
    ...
    public static MeshDefinition createNoHatModel() {
        MeshDefinition meshDefinition = createVillagerModel();
