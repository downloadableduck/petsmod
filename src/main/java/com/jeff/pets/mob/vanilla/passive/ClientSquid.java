...
public class ClientSquid extends FlyingPet {
    ...
    public void tick() {
        ...
        if (this.isInWaterOrInBubbleColumn()) {
            ...
            if (!this.world.isClient) {
                this.m_3016726(this.tx * this.speed, this.ty * this.speed, this.tz * this.speed);
            }
            ...
            if (!this.world.isClient) {
                ...
                this.m_3016726(0.0F, e * (double) 0.98F, 0.0F);
            }
    ...
    @Override
    public void m_3016726(double x, double y, double z) {
        this.m_5189207(new Vec3d(x, y, z));
        this.tx = (float) x;
        this.ty = (float) y;
        this.tz = (float) z;
    }
    ...
    @Override
    public void m_5189207(Vec3d vec3) {
        super.m_5189207(vec3);
        double x = vec3.x;
        double y = vec3.y;
        double z = vec3.z;
    }
