...
public class Racoon extends AbstractPet {
    ...
    @Override
    public @Nullable EntityData initialize(@NotNull WorldAccess level, LocalDifficulty difficulty, C_6558498 spawnReason, @Nullable EntityData groupData, NbtCompound NbtCompound) {
