...
public class Stingray extends FlyingPet {
    ...
    public @NotNull EntityData initialize(final @NotNull WorldAccess level, final @NotNull LocalDifficulty difficulty, final @NotNull C_6558498 spawnReason, final @Nullable EntityData groupData, NbtCompound NbtCompound) {
