...
public class Duck extends AbstractPet {
    ...
    public @Nullable Duck getBreedOffspring(final @NotNull AgableMob partner) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level.playLocalSound(this.getX(), this.getY(), this.getZ(), PetsSounds.DUCK_AMBIENT, SoundSource.NEUTRAL, 1.0f, 1.0f, true);
        }
    }
