...
@CanFly
public class ClientAllay extends TamableAnimal {
    public ClientAllay(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.ALLAY_AMBIENT_WITHOUT_ITEM, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
