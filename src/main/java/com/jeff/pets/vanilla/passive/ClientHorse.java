...
public class ClientHorse extends TamableAnimal {

    public ClientHorse(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.HORSE_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
