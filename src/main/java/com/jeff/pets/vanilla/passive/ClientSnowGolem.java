...
public class ClientSnowGolem extends TamableAnimal {

    public ClientSnowGolem(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.SNOW_GOLEM_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
