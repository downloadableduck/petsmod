...
public class ClientTurtle extends TamableAnimal {

    public ClientTurtle(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.TURTLE_AMBIENT_LAND, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
