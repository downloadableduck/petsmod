...
@CanFly
public class ClientAxolotl extends TamableAnimal {

    public ClientAxolotl(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.AXOLOTL_IDLE_WATER, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
