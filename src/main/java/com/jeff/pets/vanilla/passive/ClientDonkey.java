...
public class ClientDonkey extends TamableAnimal {

    public ClientDonkey(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.DONKEY_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
