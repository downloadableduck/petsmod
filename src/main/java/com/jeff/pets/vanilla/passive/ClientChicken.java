...
public class ClientChicken extends TamableAnimal {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.CHICKEN_SOUNDS.get(ChickenSoundVariants.SoundSet.CLASSIC).adultSounds().ambientSound().value(), SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
