package com.jeff.pets.vanilla.passive;
...
public class ClientPig extends TamableAnimal {

    public ClientPig(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.PIG_SOUNDS.get(PigSoundVariants.SoundSet.CLASSIC).adultSounds().ambientSound().value(), SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
