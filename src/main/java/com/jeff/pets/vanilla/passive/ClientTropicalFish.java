...
public class ClientTropicalFish extends TamableAnimal {

    public ClientTropicalFish(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.TROPICAL_FISH_AMBIENT, SoundSource.NEUTRAL, 1.0f, 1.0f);
        }
    }
