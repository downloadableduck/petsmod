...
public class ClientCopperGolem extends TamableAnimal {

    public ClientCopperGolem(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.COD_AMBIENT, SoundSource.NEUTRAL, 1.0f, 1.0f);
        }*/
    }
