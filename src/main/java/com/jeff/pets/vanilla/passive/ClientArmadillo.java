...
public class ClientArmadillo extends TamableAnimal {

    public ClientArmadillo(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.ARMADILLO_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
