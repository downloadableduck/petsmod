...
@CanFly
public class ClientGhast extends TamableAnimal {
    public ClientGhast(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.GHAST_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
