...
public class ClientZombieVillager extends TamableAnimal {
    public ClientZombieVillager(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.SILVERFISH_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
