...
public class ClientPillager extends TamableAnimal {
    public ClientPillager(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (owner != null) {
            ...
            if (distance > 2.0) {
                ...
                this.walkAnimation.setSpeed(0.75F);
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.PILLAGER_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
