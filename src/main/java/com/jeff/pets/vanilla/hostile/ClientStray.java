...
public class ClientStray extends TamableAnimal {
    public ClientStray(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.STRAY_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
