...
public class ClientWitch extends TamableAnimal {
    public ClientWitch(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.WITCH_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
