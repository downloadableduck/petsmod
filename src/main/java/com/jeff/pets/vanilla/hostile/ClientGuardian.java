...
@CanFly
public class ClientGuardian extends TamableAnimal {
    public ClientGuardian(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.GUARDIAN_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
