...
@CanFly
public class ClientPhantom extends TamableAnimal {
    public ClientPhantom(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.PHANTOM_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
