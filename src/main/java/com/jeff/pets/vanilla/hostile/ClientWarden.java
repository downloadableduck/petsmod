...
public class ClientWarden extends TamableAnimal {
    public ClientWarden(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.WARDEN_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
