...
public class ClientZombie extends TamableAnimal {
    public ClientZombie(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.ZOMBIE_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
