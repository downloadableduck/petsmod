...
public class ClientEvoker extends TamableAnimal {
    public ClientEvoker(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.EVOKER_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
