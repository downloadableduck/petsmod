...
public class ClientEndermite extends TamableAnimal {
    public ClientEndermite(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.ENDERMITE_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
