...
public class ClientRavager extends TamableAnimal {
    public ClientRavager(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.RAVAGER_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
