...
public class ClientVindicator extends TamableAnimal {

    public ClientVindicator(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.VINDICATOR_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
