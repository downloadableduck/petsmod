...
public class ClientCaveSpider extends TamableAnimal {
    public ClientCaveSpider(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.SPIDER_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
