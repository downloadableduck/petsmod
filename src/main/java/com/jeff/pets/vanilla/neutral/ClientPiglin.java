...
public class ClientPiglin extends TamableAnimal {
    public ClientPiglin(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.PIGLIN_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
