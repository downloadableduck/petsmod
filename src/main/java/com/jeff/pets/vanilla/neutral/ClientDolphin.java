...
@CanFly
public class ClientDolphin extends TamableAnimal {
    public ClientDolphin(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.DOLPHIN_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
