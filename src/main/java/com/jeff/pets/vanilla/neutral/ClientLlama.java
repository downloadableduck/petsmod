...
public class ClientLlama extends TamableAnimal {
    public ClientLlama(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.LLAMA_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
