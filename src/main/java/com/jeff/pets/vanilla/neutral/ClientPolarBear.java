...
public class ClientPolarBear extends TamableAnimal {
    public ClientPolarBear(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.POLAR_BEAR_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
