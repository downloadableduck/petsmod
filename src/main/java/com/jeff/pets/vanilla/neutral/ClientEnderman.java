...
public class ClientEnderman extends TamableAnimal {
    public ClientEnderman(EntityType<? extends @NotNull TamableAnimal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (ambient == 1) {
            level().playLocalSound(this, SoundEvents.ENDERMAN_AMBIENT, SoundSource.AMBIENT, 1.0f, 1.0f);
        }
    }
