...
public class DropdownBoxEntry<T> extends TooltipListEntry<T> {
    ...
    public List<? extends class_4122> children() {
        return Lists.<class_4122>newArrayList(selectionElement, resetButton);
    }
    ...
    public static class SelectionElement<R> extends class_4121 implements class_4122 {
    ...
    public static abstract class DropdownMenuElement<R> extends class_4121 {
    ...
    public static class DefaultDropdownMenuElement<R> extends DropdownMenuElement<R> {
        ...
        public void lateRender(int mouseX, int mouseY, float delta) {
            ...
            if (getMaxScrollPosition() > 6) {
                ...
                int bottomc = new Rectangle(scrollbarPositionMinX, minY, scrollbarPositionMaxX - scrollbarPositionMinX, height).contains(new Point(mouseX, mouseY)) ? 168 : 128;
                int topc = new Rectangle(scrollbarPositionMinX, minY, scrollbarPositionMaxX - scrollbarPositionMinX, height).contains(new Point(mouseX, mouseY)) ? 222 : 172;
                ...
                // Top
                buffer.begin(7, VertexFormats.POSITION_TEXTURE_COLOR);//.texture(0, 1).color(topc, topc, topc, 255).next();
    ...
    public static abstract class SelectionCellElement<R> extends class_4121 {
    ...
    public static class DefaultSelectionCellElement<R> extends SelectionCellElement<R> {
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int int_1) {
            ...
            if (b) {
                ...
                getEntry().selectionElement.method_18424(null);
    ...
    public static abstract class SelectionTopCellElement<R> extends class_4121 {
        ...
        public void selectFirstRecommendation() {
            ...
            for (SelectionCellElement<R> child : children) {
                if (child.getSelection() != null) {
                    ...
                    getParent().selectionElement.method_18424(null);
                    break;
                }
            }
        }
    ...
    public static class DefaultSelectionTopCellElement<R> extends SelectionTopCellElement<R> {
        ...
        public DefaultSelectionTopCellElement(R value, Function<String, R> toObjectFunction, Function<R, String> toStringFunction) {
            ...
            textFieldWidget = new TextFieldWidget(0, MinecraftClient.getInstance().textRenderer, 0, 0, 148, 18) {
                @Override
