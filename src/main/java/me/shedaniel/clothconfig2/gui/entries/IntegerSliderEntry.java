...
public class IntegerSliderEntry extends TooltipListEntry {
    ...
    public IntegerSliderEntry(String fieldName, int minimum, int maximum, int value, Consumer<Integer> saveConsumer) {
        this(fieldName, minimum, maximum, value, "text.cloth-config2.reset_value", null, saveConsumer);
    }
    ...
    private class Slider extends OptionSliderWidget {
        protected Slider(int int_1, int int_2, int int_3, int int_4, double double_1) {
            super(int_1, int_2, int_3, GameOptions.Option.MIPMAP_LEVELS, int_4, double_1);
        }
        ...
        protected void applyValue() {
            IntegerSliderEntry.this.value.set((int) (minimum + Math.abs(maximum - minimum) * value.get()));
            getScreen().setEdited(true);
        }
