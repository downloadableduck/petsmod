...
public abstract class DynamicEntryListWidget<E extends DynamicEntryListWidget.Entry<E>> extends class_4121 implements class_4122 {
    ...
    protected E getItem(int index) {
        return this.method_18423().get(index);
    }
    ...
    protected boolean isSelected(int index) {
        return Objects.equals(this.getSelectedItem(), this.method_18423().get(index));
    }
    ...
    protected final E getItemAtPosition(double mouseX, double mouseY) {
        ...
        return mouseX < (double) this.getScrollbarPosition() && mouseX >= minX && mouseX <= maxX && itemIndex >= 0 && currentY >= 0 && itemIndex < this.getItemCount() ? this.method_18423().get(itemIndex) : null;
    }
    ...
    protected void centerScrollOn(E item) {
        ...
        for (int i = 0; i < this.method_18423().indexOf(item) && i < this.getItemCount(); i++)
            d += getItem(i).getItemHeight();
        this.capYPosition(d);
    }
    
    protected void ensureVisible(E item) {
        int rowTop = this.getRowTop(this.method_18423().indexOf(item));
    ...
    public boolean mouseDragged(double double_1, double double_2, int int_1, double double_3, double double_4) {
        if (getFocused() != null && getFocused().mouseDragged(double_1, double_2, int_1, double_3, double_4)) {
            return true;
    ...
    public boolean keyPressed(int int_1, int int_2, int int_3) {
        if (getFocused() != null && getFocused().keyPressed(int_1, int_2, int_3)) {
            return true;
        } else if (int_1 == 264) {
    ...
    public boolean keyReleased(int int_1, int int_2, int int_3) {
        return getFocused() != null && getFocused().keyReleased(int_1, int_2, int_3);
    }
    
    public boolean charTyped(char char_1, int int_1) {
        return getFocused() != null && getFocused().charTyped(char_1, int_1);
    }
    
    protected void moveSelection(int int_1) {
        if (!this.method_18423().isEmpty()) {
            int int_2 = this.method_18423().indexOf(this.getSelectedItem());
            int int_3 = MathHelper.clamp(int_2 + int_1, 0, this.getItemCount() - 1);
            E itemListWidget$Item_1 = this.method_18423().get(int_3);
    ...
    @Environment(EnvType.CLIENT)
    public abstract static class Entry<E extends Entry<E>> extends DrawableHelper implements class_4122 {
