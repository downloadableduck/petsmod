...
public abstract class DynamicNewSmoothScrollingEntryListWidget<E extends DynamicEntryListWidget.Entry<E>> extends DynamicEntryListWidget<E> {
    ...
    public boolean mouseDragged(double double_1, double double_2, int int_1, double double_3, double double_4) {
        ...
        if ((this.getFocused() != null && int_1 == 0) && this.getFocused().mouseDragged(double_1, double_2, int_1, double_3, double_4)) {
            return true;
    ...
    protected void renderScrollBar(Tessellator tessellator, BufferBuilder buffer, int maxScroll, int scrollbarPositionMinX, int scrollbarPositionMaxX) {
        if (!smoothScrolling)
            ...
            int bottomc = new Rectangle(scrollbarPositionMinX, minY, scrollbarPositionMaxX - scrollbarPositionMinX, height).contains(new Point(MinecraftClient.getInstance().field_19945.method_18249(), MinecraftClient.getInstance().field_19945.method_18250())) ? 168 : 128;
            int topc = new Rectangle(scrollbarPositionMinX, minY, scrollbarPositionMaxX - scrollbarPositionMinX, height).contains(new Point(MinecraftClient.getInstance().field_19945.method_18249(), MinecraftClient.getInstance().field_19945.method_18250())) ? 222 : 172;
