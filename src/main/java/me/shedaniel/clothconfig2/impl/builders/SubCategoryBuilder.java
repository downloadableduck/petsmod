...
public class SubCategoryBuilder extends FieldBuilder<Object, SubCategoryListEntry> implements List<AbstractConfigListEntry> {
    ...
    public SubCategoryListEntry build() {
        SubCategoryListEntry entry = new SubCategoryListEntry(getFieldNameKey(), entries, expanded, false);
        entry.setTooltipSupplier(() -> tooltipSupplier.apply((List<AbstractConfigListEntry>) entry.getValue()));
        return entry;
    }
