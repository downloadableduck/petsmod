...
public class KeyCodeBuilder extends FieldBuilder<ModifierKeyCode, KeyCodeEntry> {
    ...
    public KeyCodeBuilder setErrorSupplier(@Nullable Function<class_4107.class_4108, Optional<String>> errorSupplier) {
    ...
    public KeyCodeBuilder setSaveConsumer(Consumer<class_4107.class_4108> saveConsumer) {
        return setModifierSaveConsumer(keyCode -> saveConsumer.accept(keyCode.getKeyCode()));
    }
    
    public KeyCodeBuilder setDefaultValue(Supplier<class_4107.class_4108> defaultValue) {
    ...
    public KeyCodeBuilder setDefaultValue(class_4107.class_4108 defaultValue) {
    ...
    public KeyCodeBuilder setTooltipSupplier(@NotNull Function<class_4107.class_4108, Optional<String[]>> tooltipSupplier) {
    ...
    public KeyCodeEntry build() {
        KeyCodeEntry entry = new KeyCodeEntry(getFieldNameKey(), value, getResetButtonKey(), defaultValue, saveConsumer, null, false);
