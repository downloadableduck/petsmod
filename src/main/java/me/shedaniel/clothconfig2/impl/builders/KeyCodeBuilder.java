...
public class KeyCodeBuilder extends FieldBuilder<ModifierKeyCode, KeyCodeEntry> {
    ...
    public KeyCodeBuilder setErrorSupplier(Function<KeyInput, Optional<String>> errorSupplier) {
        return setModifierErrorSupplier(keyCode -> errorSupplier.apply(keyCode.getKeyCode()));
    }

    public KeyCodeBuilder setModifierErrorSupplier(Function<ModifierKeyCode, Optional<String>> errorSupplier) {
    ...
    public KeyCodeBuilder setTooltip(String... tooltip) {
