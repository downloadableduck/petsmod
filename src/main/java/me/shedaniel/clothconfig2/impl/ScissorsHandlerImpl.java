...
public final class ScissorsHandlerImpl implements ScissorsHandler {
    ...
    public void applyScissors() {
        if (!scissorsAreas.isEmpty()) {
            ...
            double scaleFactor = WindowUtil.getGuiScale();
            GL11.glEnable(GL11.GL_SCISSOR_TEST);
            GL11.glScissor((int) (r.x * scaleFactor), (int) ((WindowUtil.getScaledHeight() - r.height - r.y) * scaleFactor), (int) (r.width * scaleFactor), (int) (r.height * scaleFactor));
        } else
